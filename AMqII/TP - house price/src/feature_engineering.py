...
class FeatureEngineeringPipeline(object):
    ...
    def __init__(self, input_path, output_path, modo):
        self.modo = modo
    ...
    def data_transformation(self, df, modo):
        """
        ...
        if modo == 'train':
            ...
            # Create a DataFrame directly without renaming columns
            final_features = ['OverallQual', 'GrLivArea', 'GarageCars',
                    'TotalBsmtSF', 'FullBath', 'YearRemodAdd',
                    'YearBuilt', 'Fireplaces', 'MasVnrArea', 'LotArea',
                    'SalePrice']
            categorical_features = ['ExterQual', 'CentralAir']
            ...
            df_transformed = pd.DataFrame([final_features, categorical_features, metadata_features])
    ...
    def run(self):
        df = self.read_data()
        df_transformed = self.data_transformation(df, modo)
...
if __name__ == "__main__":
    ...
    if modo == 'train':
        IN_PATH = r'..\\data\\train.csv'
        OUT_PATH = r'..\\data\\transformed_dataframe.csv'
    else:
        IN_PATH = r'..\data\test.csv'
        OUT_PATH = r'..\\data\\test_df_transformed.csv'
